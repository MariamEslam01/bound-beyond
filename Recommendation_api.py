...
movies = pd.read_csv("10K movies.csv")
...
combined['embedding'] = list(model.encode(combined['content'].tolist(), show_progress_bar=True))
...
def recommend():
    ...
    filtered = filtered.head(300)  # limit to avoid OOM
    ...
    for idx in indices[0]:
        ...
        image = item['image_url'] or "/static/images/Books_Default.png" if item['type'] == "book" else "/static/images/2503508.png"
